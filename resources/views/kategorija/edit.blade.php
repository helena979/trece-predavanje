...
@section('content')
 ...
 <section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <div class="scroll height-content section-content">
                <form action="{{ route('kategorija.update', $kategorija) }}" method='post' enctype="multipart/form-data" class="text-gray-700 forma">
                    @method('PUT')
                    @csrf
                    <div class="flex flex-row ml-[30px]">
                        <div class="w-[50%] mb-[100px]">
                            <div class="mt-[20px]">
                                ...
                                <input value='{{$kategorija->Naziv}}' type="text" name="nazivKategorijaEdit" id="nazivKategorijeEdit" value="Hrana i pice"
                                    class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]"
                                    {{$kategorija->Naziv}}
                                    onkeydown="clearErrorsNazivKategorijeEdit()" />
                                <div id="validateNazivKategorijeEdit">
                                    @error('nazivKategorijeEdit')
                                        {{ dd($errors) }}   
                                    @enderror    
                                </div>
                            </div>
                                ...
                                <div id="empty-cover-art-ikonica"
                                    ...
                                    <div class="bg-gray-300 h-[40px] w-[102px] px-[20px] pt-[10px]">
                                        <label class="cursor-pointer">
                                            ...
                                            <input id="icon-upload" name="slika" type='file' class="hidden" :multiple="multiple"
                                                :accept="accept" />
                                        </label>
                                    </div>
                            ...
                            <div class="mt-[20px]">
                                ...
                                <textarea name="opisKategorija" rows="10"
